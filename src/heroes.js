...
"qual": "component",
"cost": 2250,
"desc": "Active: Blink - Teleport to a target point up to %blink_range% units away.  If damage is taken, Blink Dagger cannot be used for %blink_damage_cooldown% seconds.",
...
"qual": "consumable",
"cost": 75,
"desc": "Use: Consume the Faerie Fire to instantly restore %hp_restore% HP",
"notes": "",
...
"qual": "component",
"cost": 225,
"desc": "Passive: Consumes a charge to block %magic_damage_block% magic damage from damage instances over %min_damage% damage. Comes with %initial_charges% charges. When the charges are gone, the item disappears.",
...
"qual": "common",
"cost": 4000,
"desc": "Use: Consume the Moon Shard to permanently gain %consumed_bonus% attack speed. Does not stack.<br />\r\nPassive: Shade Sight - Grants %bonus_night_vision% bonus night vision.",
...
"qual": "component",
"cost": 50,
"desc": "Active: Targets the ground to plant a happy little tree that lasts for %tree_duration% seconds.",
"notes": "",
...
"qual": "component",
"cost": 200,
"desc": "Active: Energy Charge - Instantly restores health and mana based on the number of charges stored. Gains a charge (max %max_charges%) whenever a nearby visible enemy uses an ability.",
...
"qual": "consumable",
"cost": 110,
"desc": "Use: Consume the mango to instantly restore %replenish_amount% mana.<br />\r\n<br />\r\nHold Control to use Enchanted Mango on an allied hero.",
"notes": "",
...
"qual": "consumable",
"cost": 65,
"desc": "Use: Plants an Observer Ward, an invisible watcher that gives vision of its surrounding area to your team. Lasts %duration_minutes_tooltip% minutes.<br />\r\n<br />\r\nHold Control to give one Observer Ward to an allied hero.",
"notes": "",
...
"qual": "consumable",
"cost": 200,
"desc": "Use: Plants a Sentry Ward, an invisible watcher that grants True Sight, the ability to see invisible enemy units and wards, to any existing allied vision within its range. Lasts %duration_minutes_tooltip% minutes.<br />\r\n<br />\r\nHold Control to give one Sentry Ward to an allied hero.",
"notes": "",
...
"qual": "common",
"cost": 2050,
"desc": "Active: Transmute - Kills a non-hero target for %bonus_gold% gold and %xp_multiplier%x experience.  Cannot be used on Ancient Creeps.",
...
"qual": "common",
"cost": 500,
"desc": "Passive: Damage Block - Blocks physical attack damage based on whether the equipped hero is ranged or melee.  Poor Man's Shield will always block attacks from enemy Heroes, but has a %block_chance%% chance to block damage from creeps.",
"notes": "Multiple sources of damage block don't stack.",
...
"qual": "rare",
"cost": 2275,
"desc": "Active: Restore - Heals %heal_amount% health and gives +%heal_bonus_armor% armor to allied units in a %heal_radius% radius.<br />\r\nPassive: Mekansm Aura - Grants %aura_health_regen% health regeneration to allied units in a %aura_radius% radius.<br />\r\n<br />\r\nMultiple instances of Mekansm Aura do not stack.",
...
"qual": "rare",
"cost": 2275,
"desc": "Passive: Vladmir's Aura - Grants lifesteal, health regeneration, mana regeneration, bonus attack damage, and armor to allies in a %aura_radius% radius.  The lifesteal percentage is based on whether the hero affected by the aura is melee or ranged.<br />\r\n<br />\r\nMultiple instances of Vladmir's Aura do not stack.",
...
"qual": "rare",
"cost": 800,
"desc": "Active: Armor Bonus - Gives +%bonus_aoe_armor% armor to all allied units in a %bonus_aoe_radius% radius.  Lasts 25 seconds on heroes, 30 seconds on units.",
"notes": "",
...
"qual": "rare",
"cost": 3100,
"desc": "Active: Barrier - Gives a shield that blocks %barrier_block% spell damage to all allies in a %barrier_radius% radius.<br />\r\nPassive: Insight Aura - Gives allied units %aura_health_regen% health regeneration and %magic_resistance_aura%% magic resistance in a %aura_radius% radius.",
...
"qual": "rare",
"cost": 575,
"desc": "Passive: Regeneration Aura - Restores health to allies in a %aura_radius% unit radius.<br />\r\n<br />\r\nMultiple instances of Regeneration Aura do not stack.",
"notes": "",
...
"qual": "rare",
"cost": 5650,
"desc": "Active: Hex - Turns a target unit into a harmless critter for %sheep_duration% seconds. Instantly destroys illusions.",
...
"qual": "rare",
"cost": 4075,
"desc": "Active: Soul Burn - Silences the target unit for %silence_duration% seconds. At the end of the silence, %silence_damage_percent%% of the damage received while silenced is inflicted as bonus magical damage.",
"notes": "",
...
"qual": "epic",
"cost": 7195,
"desc": "Active: Silences a target for %silence_duration% seconds and amplifies the damage it takes by %silence_damage_percent%%. All attacks on the silenced target will have True Strike and land a crit on impact.<br />\r\nPassive: Critical Strike - Grants each attack a chance to deal additional damage. Critical Strike does not work against buildings.",
...
"qual": "artifact",
"cost": 2650,
"desc": "Passive: Causes melee attacks to attack twice in quick succession. The double attacks apply a %slow_duration% second %movement_slow%% movement and attack speed slow on each strike.",
"notes": "",
...
"qual": "rare",
"cost": 2750,
"desc": "Active: Cyclone - Sweeps a target unit up into cyclone, making them invulnerable for %cyclone_duration% seconds. Cyclone can be cast on yourself. Enemy units take 50 magical damage upon landing.<br />\r\n<br />\r\nDISPEL TYPE: Basic Dispel",
...
"qual": "rare",
"cost": 2350,
"desc": "Passive: Increases spell cast range by %cast_range_bonus% and spell damage output by %spell_amp%%",
"notes": "",
...
"qual": "rare",
"cost": 2225,
"desc": "Active: Force - Pushes any target unit %push_length% units in the direction it is facing.  Double click to instantly cast Force on yourself.",
...
"qual": "epic",
"cost": 4375,
"desc": "Active: When used on an enemy, it pushes you both away from each other %enemy_length% units each, and allows you to attack the target without range restrictions for %max_attacks% attacks for a maximum of %range_duration% seconds. Grants %bonus_attack_speed% Attack Speed during the attacks. Works like Force Staff when used on self or allies.<br />\r\nPassive: Increases attack range of ranged heroes by %base_attack_range%.",
...
"qual": "rare",
"cost": 2650,
"desc": "Active: Demonic Summoning - Summons a Warrior and an Archer to fight for you for %summon_duration% seconds, whose strength and abilities increase as Necronomicon is upgraded. Warrior gains True Sight at level 3. Upgradable.",
"notes": "",
...
"qual": "rare",
"cost": 5050,
"desc": "Active: Demonic Summoning - Summons a Warrior and an Archer to fight for you for %summon_duration% seconds, whose strength and abilities increase as Necronomicon is upgraded. Warrior gains True Sight at level 3.",
"notes": "",
...
"qual": "epic",
"cost": 5500,
"desc": "Passive: Health Regeneration - Restores a percentage of max health per second. If damage is taken from an enemy hero or Roshan, this ability is disabled for %cooldown_melee% seconds for melee heroes, or %cooldown_ranged_tooltip% seconds for ranged heroes.",
"notes": "",
...
"qual": "artifact",
"cost": 0,
"desc": "Passive: Reincarnation - Brings you to life with full health and mana %reincarnate_time% seconds after you die, at the location where you died. Reincarnation must be used within %disappear_time_minutes_tooltip% minutes or Aegis of the Immortal disappears. If it expires, it will heal you over 5 seconds (dispels on damage).",
"notes": "",
"attrib": "",
"mc": false,
"cd": false,
...
"qual": "epic",
"cost": 4700,
"desc": "Active: Arctic Blast - Emits a freezing wave that deals %blast_damage% magical damage to enemies and slows their movement by %blast_movement_speed%% for %blast_debuff_duration% seconds.<br />\r\nPassive: Freezing Aura - Reduces the attack speed of all enemies in a %aura_radius% radius.<br />\r\n<br />\r\nMultiple instances of Freezing Aura do not stack.",
...
"qual": "epic",
"cost": 4900,
"desc": "Active: Pocket Deny - Instantly causes you to die.<br />\r\nPassive: Bloodpact - Begins with 12 charges, and gains a charge each time an enemy hero dies within 1675 range. Each charge grants 1 mana regeneration per second, and reduces respawn time by %respawn_time_reduction% seconds. If the bearer dies, %heal_on_death_base% + %heal_on_death_per_charge% health per charge is restored to all allies within a %heal_on_death_range% radius, while the Bloodstone loses a third of its charges.",
...
"qual": "epic",
"cost": 2150,
"desc": "Passive: Damage Block - Grants the wielder a %block_chance%% chance to block damage from incoming attacks based on whether the equipped hero is melee or ranged.",
"notes": "Multiple sources of damage block don't stack.",
...
"qual": "epic",
"cost": 3550,
"desc": "Active: Guard - Grant nearby allied heroes and buildings a %block_chance_active%% chance to block %block_damage_melee_active% damage from each incoming attack, along with %bonus_aoe_armor% armor. Lasts 10 seconds.<br />\r\nPassive: Damage Block - Grants the wielder a %block_chance%% chance to block damage from incoming attacks based on whether the equipped hero is melee or ranged.",
...
"qual": "epic",
"cost": 1725,
"desc": "Active: Creates a spell shield that absorbs up to %barrier_block% magical damage.",
"notes": "Stacks multiplicatively with other sources of spell resistance.",
...
"qual": "epic",
"cost": 5150,
"desc": "Active: Toggle Burn - When active, scorches nearby enemies for %aura_damage% damage per second and blinds them, causing them to miss %blind_pct%% of their attacks.",
"notes": "",
...
"qual": "epic",
"cost": 5525,
"desc": "Active: Flutter - Trade evasion for %bonus_move_speed%% additional movement speed for 4.0 seconds.<br />\r\n<br />\r\nStacks diminishingly with other sources of Evasion.",
"notes": "",
...
"qual": "epic",
"cost": 2700,
"desc": "Passive: Bash - Grants each attack a chance to stun the target for %bash_duration% seconds and deal %bonus_chance_damage% bonus damage, based on whether the equipped hero is ranged or melee.",
...
"qual": "epic",
"cost": 4950,
"desc": "Active: Mirror Image - Creates %images_count% images of your hero that last %tooltip_illusion_duration% seconds. Melee heroes have a %cooldown_melee% second cooldown on this ability, while for Ranged heroes the cooldown is %cooldown_ranged_tooltip% seconds.<br />\r\n<br />\r\nMelee images deal %tooltip_damage_outgoing_melee%% damage and take %tooltip_damage_incoming_melee_total_pct%% damage, while Ranged images deal %tooltip_damage_outgoing_ranged%% and take %tooltip_damage_incoming_ranged_total_pct%% damage.<br />\r\n<br />\r\nYasha-based movement speed bonuses from multiple items do not stack.<br />\r\n<br />\r\nDISPEL TYPE: Basic Dispel",
...
"qual": "artifact",
"cost": 1900,
"desc": "Passive: Increases attack range of ranged heroes by %base_attack_range%.",
"notes": "Multiple instances do not stack.",
...
"qual": "epic",
"cost": 2370,
"desc": "Active: Toggle Unholy Strength - When active, Unholy Strength grants +%unholy_bonus_damage% damage and +%unholy_bonus_strength% strength, but drains %unholy_health_drain_per_second_tooltip% health per second.  You cannot die from the health drain when Unholy Strength is activated, nor from the strength loss when Unholy Strength is deactivated.",
...
"qual": "epic",
"cost": 2700,
"desc": "Active: Shadow Walk - Makes you invisible until the duration ends, or until you attack or cast a spell.  While Shadow Walk is active, you move %windwalk_movement_speed%% faster and can move through units.  If attacking to end the invisibility, you gain %windwalk_bonus_damage% bonus damage on that attack.  Lasts %windwalk_duration% seconds.",
...
"qual": "artifact",
"cost": 4100,
"desc": "Passive: Greater Maim - Each attack has a chance to slow the enemy's movement and attack speed for %maim_duration% seconds.<br />\r\n<br />\r\nYasha-based movement speed bonuses from multiple items do not stack.",
"notes": "",
...
"qual": "artifact",
"cost": 5700,
"desc": "Active: Static Charge - Places a charged shield on a target unit which has a %dstatic_chance%% chance to release a shocking bolt at a nearby attacker and %dstatic_strikes% additional enemies.<br />\r\nPassive: Chain Lightning - Grants a chance on attack to release a bolt of electricity that leaps between %dchain_strikes% targets, dealing %dchain_damage% magical damage to each.",
...
"qual": "artifact",
"cost": 2050,
"desc": "Passive: Lesser Maim - Each attack has a chance to slow the enemy's movement and attack speed for %maim_duration% seconds.",
"notes": "",
...
"qual": "artifact",
"cost": 1800,
"desc": "Active: Dominate - Take control of a non-hero, non-ancient target unit and sets its movement speed to %speed_base%. If a dominated creep's base health is naturally below the health minimum, its base health will be raised to the health minimum.",
...
"qual": "artifact",
"cost": 2800,
"desc": "Passive: Chain Lightning - Grants a chance on attack to release a bolt of electricity that leaps between %dchain_strikes% targets, dealing %dchain_damage% magical damage to each.",
"notes": "",
...
"qual": "artifact",
"cost": 1900,
"desc": "Active: Berserk - Gives %berserk_bonus_attack_speed% attack speed and %berserk_bonus_movement_speed%% movement speed, but reduces your armor by %berserk_armor_reduction% and silences you.  Lasts %berserk_duration% seconds.<br />\r\nPassive: Lifesteal - Heals the attacker for a percentage of attack damage dealt.<br />\r\n<br />\r\nMask of Madness is a Unique Attack Modifier, and does not stack with other Unique Attack Modifiers.",
"notes": "",
...
"qual": "artifact",
"cost": 3150,
"desc": "Active: Purge - Targets an enemy, removing buffs from the target and slowing it for %purge_slow_duration% seconds.<br />\r\nPassive: Manabreak - Each attack burns %feedback_mana_burn% mana from the target, and deals %damage_per_burn% physical damage per burned mana. Burns %feedback_mana_burn_illusion_melee% mana per attack from melee illusions and %feedback_mana_burn_illusion_ranged% mana per attack from ranged illusions. Does not stack with other manabreak abilities.<br />\r\n<br />\r\nUpgradable.<br />\r\n<br />\r\nDISPEL TYPE: Basic Dispel",
"notes": "",
...
"qual": "artifact",
"cost": 3850,
"desc": "Active: Purge - Targets an enemy, removing from the target and slowing it for %purge_slow_duration% seconds.<br />\r\nPassive: Manabreak - Each attack burns %feedback_mana_burn% mana from the target, and deals %damage_per_burn% physical damage per burned mana. Burns %feedback_mana_burn_illusion_melee% mana per attack from melee illusions and %feedback_mana_burn_illusion_ranged% mana per attack from ranged illusions. Does not stack with other manabreak abilities.<br />\r\n<br />\r\nDISPEL TYPE: Basic Dispel",
"notes": "",
...
"qual": "common",
"cost": 800,
"desc": "Active: Sacrifice - Consume %health_sacrifice% health to temporarily gain %mana_gain% mana.  Lasts 10 seconds.",
...
"qual": "rare",
"cost": 1300,
"desc": "Active: Replenish Mana - Restores mana to all allies in a %replenish_radius% area around the hero.<br />\r\n<br />\r\nFlat movement speed bonuses from multiple pairs of boots do not stack.",
...
"qual": "rare",
"cost": 5900,
"desc": "Passive: Cooldown Reduction - Reduces the cooldown time of all spells and items by %bonus_cooldown%%.<br />\r\nPassive: Spell Lifesteal - A percentage of damage caused by spells is returned to the caster as health.",
"notes": "",
...
"qual": "rare",
"cost": 1780,
"desc": "Active: Endurance - Gives bonus +%bonus_attack_speed_pct% attack speed and +%bonus_movement_speed_pct%% movement speed to allies in a 900 radius.<br />\r\nPassive: Swiftness Aura - Gives bonus movement speed to allies in a 900 radius.<br />\r\n<br />\r\nMultiple instances of Swiftness Aura do not stack.",
...
"qual": "consumable",
"cost": 50,
"desc": "Use: Upon activation, the user and all nearby allied player-controlled units gain invisibility and bonus movement speed for a brief time.  Minimap icons will also be hidden.  Attacking, or moving within %visibility_radius% range of an enemy hero or tower, will break the invisibility.",
"notes": "",
...
"qual": "consumable",
"cost": 150,
"desc": "Use: Grants you %xp_bonus% experience plus %xp_per_use% per tome comsumed by your team.",
"notes": "",
...
"qual": "rare",
"cost": 2240,
"desc": "Active: Magic Weakness - Emits a weakening blast that increases the magic damage enemies take. Lasts %resist_debuff_duration% seconds.",
...
"qual": "rare",
"cost": 5275,
"desc": "Active: Mend - Restores %replenish_health% health and %replenish_mana% mana to nearby allies, and removes most negative buffs from the caster.<br />\r\nPassive: Guardian Aura - Provides nearby allies with %aura_health_regen% health regeneration and %aura_armor% bonus armor. If an allied hero's health falls below %aura_bonus_threshold%%, they receive %aura_health_regen_bonus% health regeneration and %aura_armor_bonus% armor.<br />\r\n<br />\r\nDISPEL TYPE: Basic Dispel",
...
"qual": "common",
"cost": 500,
"desc": "Active: Targets a non-player enemy unit to remove %creep_damage_pct%% of its current HP.<br />\r\nPassive: Quell - Increases attack damage against non-hero units, based on whether the equipped hero is ranged or melee.",
...
"qual": "epic",
"cost": 6400,
"desc": "Active: Overwhelm - Stuns a target enemy unit for %dstun_duration% seconds. Pierces Spell Immunity.<br />\r\nPassive: Bash - Grants each attack a chance to stun the target for %bash_duration% seconds and deal %bonus_chance_damage% bonus damage, based on whether the equipped hero is ranged or melee.<br />\r\nPassive: Damage Block - Grants the wielder a %block_chance%% chance to block damage from incoming attacks based on whether the equipped hero is melee or ranged.",
...
"qual": "artifact",
"cost": 3500,
"desc": "Active: Disarm - Prevents a target from attacking. Lasts %disarm_melee% seconds on melee targets, and %disarm_range% seconds on ranged targets.<br />\r\nPassive: Lesser Maim - Each attack has a chance to slow the enemy's movement and attack speed for %maim_duration% seconds.<br />\r\n<br />\r\nStacks diminishingly with other sources of Evasion.",
...
"qual": "rare",
"cost": 985,
"desc": "Passive: Aquila Aura - Grants mana regeneration and armor in a %aura_radius% area of effect.<br />\r\nActive: Toggle whether the aura affects other non-hero units.<br />\r\n<br />\r\nMultiple instances of Aquila Aura do not stack.",
"notes": "Does not stack with armor auras from Ring of Basilius, Ring of Aquila, or Vladmir's Offering.",
...
"qual": false,
"cost": 1300,
"desc": "Active: Fade - Grants invisibility to you or a target allied hero after a %fade_time% second fade time. Moving breaks the invisibility. There is no cooldown when using this item on yourself.",
"notes": "",
...
"qual": "rare",
"cost": 1850,
"desc": "Active: Glimmer - After a %fade_delay% second delay, grants invisibility and %active_magical_armor%% magic resistance to you or a target allied unit. Can be cast while channelling.",
"notes": "",
...
Object.keys(o.itemdata).forEach((key) => {
    const h = o.itemdata[key];
    out[h.id+''] = h;
    out[h.id+''].img = 'http://cdn.dota2.com/apps/dota2/items/heroes/' + h.img.split('?').shift();
    out[h.id+''].key = key;
})
